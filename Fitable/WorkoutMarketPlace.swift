        ...
        ZStack {
            VStack {
                ...
                if currenttab == "Exercises" {
                    ...
                    let exercises = ["Squats", "Pushups","Jumping Jacks", "Burpees", "Single-Leg-Deadlifts"]
                        ...
                        ForEach(exercises, id: \.self) { exercise in
                            ZStack {
                                ...
                                .onTapGesture {
                                    ...
                                    PoseEstimator.shared.squatCount = 0
                                    PoseEstimator.shared.LungeCounter = 0
                                    PoseEstimator.shared.JumpingJackCounter = 0
                                    PoseEstimator.shared.PushupCounter = 0
                                    PoseEstimator.shared.SLDeadliftsCounter = 0
                                    PoseEstimator.shared.BurpeesCounter = 0
                                    print(exercise)
                                    withAnimation {
                            ...
                            VStack {
                                ...
                                if showDescriptionWorkout!.type == "Public" {
                                    ...
                                    HStack(spacing: 15) {
                                        Button {
                                            try! userdata.realm.write {
                                                showDescriptionWorkout?.likes.append(userdatafile.Username)
                                                if showDescriptionWorkout!.dislikes.contains(userdatafile.Username) {
                                                    if let index = showDescriptionWorkout!.dislikes.firstIndex(of: userdatafile.Username) {
                                        ...
                                        Button {
                                            try! userdata.realm.write {
                                                showDescriptionWorkout?.dislikes.append(userdatafile.Username   )
                                                if showDescriptionWorkout!.likes.contains(userdatafile.Username) {
                                                    if let index = showDescriptionWorkout!.likes.firstIndex(of: userdatafile.Username) {
